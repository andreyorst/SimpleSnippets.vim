...
if !exists("SimpleSnippets_autocmd_loaded")
	...
	autocmd InsertCharPre * let s:col_pre = getcurpos()[2]
	autocmd TextChangedI  * call SimpleSnippets#handleUserInput()
	autocmd TextChangedP  * call SimpleSnippets#handleUserInput()
	autocmd InsertEnter   * call SimpleSnippets#handleUserInput()
	autocmd InsertLeave   * call SimpleSnippets#fixUserInput()
	autocmd CursorHoldI   * call SimpleSnippets#updateSnippetInMemory(s:current_snip)
endif

function! SimpleSnippets#handleUserInput()
	call SimpleSnippets#obtainInput()
	call SimpleSnippets#updateSnippetInMemory(s:current_snip)
	call SimpleSnippets#updateMirrors(s:mirrors)
	echo s:text
	return ''
endfunction

function! SimpleSnippets#fixUserInput()
	call SimpleSnippets#deactivateInputDetection()
	call SimpleSnippets#updateSnippetInMemory(s:current_snip)
	call SimpleSnippets#updateMirrors(s:mirrors)
	echo s:text
	return ''
...
function! SimpleSnippets#deactivateInputDetection()
	let s:input_active = 0
	let s:line = 1
	let s:col_pre = 1
	let s:len = 0
...
function! SimpleSnippets#obtainInput()
...
function! SimpleSnippets#updateMirrors(pos)
	return ''
endfunction

function! SimpleSnippets#updateSnippetInMemory(snip)
	return ''
endfunction
